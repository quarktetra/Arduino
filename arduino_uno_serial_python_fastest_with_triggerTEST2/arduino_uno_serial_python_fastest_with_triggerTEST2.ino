...
void loop() {
  if(calibratationDone==0){
      analogWrite(TransistorBasePin,0);
        digitalWrite(RelayTransistorBasePin,LOW);
 Serial.println("Will do a calibration");
 delay(1000);
...
centerOV=analogRead(OpticalSensorPin);
 ...
 //Serial.print("; current:");Serial.print(theC);; Serial.print("; Voltage:");Serial.println(analogRead(VoltageSensorPin)); 
     ...
     Serial.print("centerOV:");Serial.print(centerOV); Serial.print(", deltaOV:");Serial.println(initOV-centerOV); 
calibratationDone=1;
  digitalWrite(RelayTransistorBasePin,HIGH);
      
       Serial.print("; calibratationDone:");Serial.println(calibratationDone);
    }
  analogWrite(TransistorBasePin,0);
